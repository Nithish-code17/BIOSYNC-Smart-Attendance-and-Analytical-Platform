...
BIOSYNC is developed as an innt attendance automation platform for educational institutions. It connects biometric attendance data with automated processing tools and real-time reporting system
